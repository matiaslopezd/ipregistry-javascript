...
### Set API Key after instance `IpregistryClient`

In case you need set API Key after instance a new `IpregistryClient` client.
...
**WARNING:** You need instance `IpregistryClient` outside of a new request (server). If you set inside of request the behavior of caching not will as you expect.
